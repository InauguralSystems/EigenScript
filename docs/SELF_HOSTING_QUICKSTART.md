...
├── lexer.eigs        # Tokenization (~700 lines)
├── parser.eigs       # AST building (~1800 lines)
├── semantic.eigs     # Variable scoping (~600 lines)
├── codegen.eigs      # LLVM IR generation (~2300 lines)
└── main.eigs         # Pipeline orchestration (~320 lines)
