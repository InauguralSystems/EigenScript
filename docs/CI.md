...
reference walk still runs, exactly as before). **Which of those happened is on
the OK line**, `repos=verified:N` or `repos=skipped:<why>` (round-5 blind
