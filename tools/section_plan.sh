...
9fef333a08d4fcad|(c) sub-check: [99zb] relays the portability tool rows, one of which announces SKIPPED; the section fails unless the tool reports OK or that announced skip
