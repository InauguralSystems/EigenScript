...
Seven fixed so far: **#155** (`call_argc` uninitialized on vm_run
...
can't queue gigabytes into SDL in one call). Remaining before tagging
0.13.0: small/docs issues #153–#154 and #157–#159.
