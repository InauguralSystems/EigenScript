...
. "$TESTS_DIR/suite_plan.sh" || exit 1

PASS=0
FAIL=0
TOTAL=0
LEAKED=0
# A section that SKIPPED measured nothing, and round 5's ILP32 gate (deleted, #1274) proved that
...
TOTAL=$((TOTAL + 1))
if python3 "$TESTS_DIR/../tools/road_diff.py" && \
